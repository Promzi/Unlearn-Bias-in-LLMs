...
# Save Directories
BASE_SAVE_DIR = Path("BBQ_Qwen_32B")
...
def plot_heatmap(tensor, title, path, xlabel="Tokens", ylabel="Hidden Size", token_labels=None):
    ...
    ax = sns.heatmap(
        ...
        linewidths=0,
        # linecolor='white',
        xticklabels=token_labels if token_labels else True,
        yticklabels=token_labels if token_labels else True
    )
...
# 🔧 Prune Heads
def prune_heads(model, head_correlations, thresholds=(0.005, 0.01, 0.02, 0.05)):
